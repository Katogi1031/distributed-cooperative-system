/* 
 ...
 Function:     Predator(int field1[16][16], int field2[16][16], int field2[16][16], int field2[16][16], int *point1, int *point2, int *point3, int *point4)
 Description:  Determine the actions of the four predators from the given arguments
...
static int predator_map[WORLD_SIZE][WORLD_SIZE] = {
...
static int predator_history[WORLD_SIZE][WORLD_SIZE] = { 
